...
export const H1: React.FC<TypographyProps> = ({ children, className = '' }) => (
  <h1
    className={`text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl ${className}`}
  >
    {children}
  </h1>
)
...
export const H4: React.FC<TypographyProps> = ({ children, className = '' }) => (
  <h4
    className={`text-xs font-bold tracking-wide text-gray-900 uppercase ${className}`}
  >
    {children}
  </h4>
)
...
export const Label: React.FC<TypographyProps & { htmlFor?: string }> = ({
  ...
  if (htmlFor) {
    return (
      <label
        htmlFor={htmlFor}
        className={`text-xs font-bold tracking-wider text-gray-600 uppercase ${className}`}
      >
        {children}
      </label>
    )
...
export const LabelSmall: React.FC<TypographyProps> = ({
  ...
  <span
    className={`text-[10px] font-medium tracking-wide text-gray-500 uppercase ${className}`}
  >
    {children}
  </span>
)
...
export const MonoHighlight: React.FC<TypographyProps> = ({
  ...
  <span
    className={`rounded-sm bg-gray-200 px-1 font-mono text-gray-900 ${className}`}
  >
    {children}
  </span>
)
...
export const AxisLabel: React.FC<SvgTextProps> = ({
  ...
  <text className={`fill-gray-500 font-mono text-xs ${className}`} {...props}>
    {children}
  </text>
)
...
export const AxisLabelSmall: React.FC<SvgTextProps> = ({
  ...
  <text
    className={`fill-gray-500 font-mono text-[10px] ${className}`}
    {...props}
  >
    {children}
  </text>
