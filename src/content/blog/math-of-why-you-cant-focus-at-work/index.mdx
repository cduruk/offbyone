...
| Job Role                  | Interruptions/Hour | Recovery Time | Sources                                                                                                                                                                                            |
| ------------------------- | ------------------ | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Knowledge Workers         | 7.5–15             | 10–23 min     | [Iqbal & Horvitz 2007](https://doi.org/10.1145/1240624.1240730), [Baethge & Rigotti 2013](https://doi.org/10.1037/a0031525), [Mark et al.](https://ics.uci.edu/~gmark/chi08-mark.pdf)              |
| PMs / Heavy Collaborators | ~30 (every 2 min)  | —             | [Microsoft Work Trend Index, 2025](https://www.microsoft.com/en-us/worklab/work-trend-index/2025)                                                                                                  |
| Software Engineers        | 4–5                | 10–45 min     | [O'Conaill & Frohlich 1995](https://doi.org/10.1145/223904.223941), [Ma et al. 2024](https://doi.org/10.1145/3597503.3639174), [Parnin & Rugaber 2011](https://doi.org/10.1109/VLHCC.2011.6070404) |

Baethge & Rigotti found that knowledge workers face up to 15 interruptions per hour, meaning λ = 15, or one interruption every four minutes. The Microsoft Work Trend Index reports that heavy collaborators (PMs, team leads) can see 30 interruptions per hour—one every two minutes! Even software engineers, who often have more control over their environment, still face 4–5 interruptions per hour and take 10–45 minutes to fully recover according to Ma et al.

### What the Research Data Actually Looks Like

If those numbers sound crazy or too high to be real, you are not alone. Look back at the visualizations you've seen so far in this post. We looked at days where λ is between 0 and 4 per hour, and Δ between 5 and 30 minutes. **These are the polite, toned-down versions of reality.** If Baethge & Rigotti see λ = 15 and Microsoft sees λ = 30 for heavy collaborators, our λ = 2–3 examples are actually best-case scenarios for many real environments.

Here's 100 days with λ = 15 (the Baethge & Rigotti knowledge worker data—one interruption every four minutes) and Δ = 25 (moderate recovery time):
...
This is the [modern workplace](https://www.apa.org/news/podcasts/speaking-of-psychology/attention-spans). Baethge & Rigotti measured λ = 15 for general knowledge workers. Microsoft reports λ = 30 for heavy collaborators. These researchers are describing millions of people's actual working conditions. And at these parameters, the math is unambiguous: deep work is statistically near-impossible. We've normalized an environment where focus has been engineered out of the workday. No wonder everyone's stressed!
...
- The **"typical" world** (amber border, λ = 2.0, Δ = 20) is still more generous than the ~15 interruptions/hour Baethge & Rigotti report for general knowledge workers, but it's already rough for 60-minute deep work.
...
Ma et al. report that software engineers take 10–15 minutes to resume work and 30–45 minutes for full context recovery. The variance is huge, and much of it comes from preparedness and task similarity. If you are or your task is on the high end of that delta (Δ ≈ 40), small hygiene improvements can cut that in half.
