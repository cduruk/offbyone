...
The above simulation was when things were cheery. But how when things go sideways?
...
So far we've fixed the knobs (λ, Δ, θ) and watched the random outcomes (individual days, grids of 100 days). Let's extend our model to actually a lot of potential parameters at once. We want to bee able to vary λ and Δ systematically and measure the resulting capacity for a given θ.
